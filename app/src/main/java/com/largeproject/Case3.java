...
public class Case3 extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuitem) {
                switch (menuitem.getItemId()) {
                    ...
                    case R.id.home:
                        ...
                        Intent i=new Intent(Case3.this,BottomNavbar.class);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        switch (position){
            case 1:
                Intent i=new Intent(Case3.this,Case1.class);
                i.putExtra("timestamp", buttcheeks);
                i.putExtra("status", oneorzero);
                i.putExtra("name", array2);
                startActivity(i);
                break;
            case 2:
                Intent in=new Intent(Case3.this,Case1.class);
                ...
                break;
            case 3:
                Intent it=new Intent(Case3.this,Case3.class);
                ...
                break;
            case 4:
                Intent a=new Intent(Case3.this,Case4.class);
                ...
                break;
            case 5:
                Intent s=new Intent(Case3.this,Case5.class);
                ...
                break;
            case 6:
                Intent intent=new Intent(Case3.this,Case6.class);
